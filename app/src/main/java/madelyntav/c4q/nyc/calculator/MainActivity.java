...
public class MainActivity extends ActionBarActivity {
    ...
    // getting rid of the negative sign, otherwise if no sign is there it will convert it to negative
        try {
...
//This method checks how many open and closing parens are currently in the equation and does some
